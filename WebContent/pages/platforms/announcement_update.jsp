...
<script type="text/javascript">
	...
	KindEditor.ready(function(K) {
		...
		$("a[name='updateAnnouncement']").click(function() {
			...
			$.ajax({
				type : "POST",
				url : "/admin/announcement/update.do",
				data : {
					id : "${announcement.id}",
					typeId : typeId,
					title : title,
...
<body>
	<div class="w1200">
		<div class="waper fr">
			<h3 class="big-title">编辑公告</h3>

			<h3 class="small-title">编辑公告</h3>
			
			<h3 class="title">公告类型</h3>

			<div class="kindeditors">
				<input type="radio" name="typeId" value="1" <c:if test="${announcement.typeId == 1 }">checked="checked"</c:if>>欢迎公告
				<input type="radio" name="typeId" value="2" <c:if test="${announcement.typeId == 2 }">checked="checked"</c:if>>普通公告
			</div>
			<h3 class="title">公告标题</h3>

			<div class="kindeditors">
				<input type="text" name="title" style="width:500px;" value="${announcement.title }">
			</div>
			<h3 class="title">公告图片</h3>

			<div class="img-all">
				<div id="load_img" class="imgs fl" >
					<img alt="" src="${announcement.annoImage}" width="200" height="150">
				</div>
				<div class="texts fl">
				...
				<input type="hidden" name="annoImage" value="${announcement.annoImage}"/>
			</div>
			<h3 class="title">正文</h3>

			<div class="kindeditors">
				<textarea name="content" style="width:1000px;height:300px;">${announcement.content}</textarea>
			</div>
			<h3 class="title"></h3>

			<div class="btns-paper">
				<a href="javaScript:" name="updateAnnouncement" class="submit">保存</a>
			</div>
		</div>
	</div>
</body>
